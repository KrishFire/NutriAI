...
describe('ActivityLevelScreen', () => {
  it('renders all activity level options', () => {
    ...
    expect(screen.getByText('This helps us calculate your daily calorie needs')).toBeTruthy();
  ...
  it('renders with correct styling for unselected options', () => {
    ...
    const lightlyActiveButton = screen.getByTestId('activity-option-lightly_active');
  ...
  it('highlights selected option with correct styling', () => {
    ...
    const moderateButton = screen.getByTestId('activity-option-moderately_active');
  ...
  it('renders option titles and descriptions correctly', () => {
    ...
    const sedentaryTitle = sedentaryOption.findByProps({ children: 'Sedentary' });
    const sedentaryDesc = sedentaryOption.findByProps({ children: 'Little to no exercise' });
